...
var FilesController = /** @class */ (function () {
    ...
    FilesController.prototype.uploadFile = function (file) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.filesService.saveFileMetadata(file)];
            });
        });
    };
    FilesController.prototype.getFile = function (path, res) {
        return __awaiter(this, void 0, void 0, function () {
            var filePath;
            return __generator(this, function (_a) {
                filePath = this.filesService.validateFileExistence(path);
    ...
    __decorate([
        common_1.Get('*'),
        __param(0, common_1.Param('0')), __param(1, common_1.Res())
