...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.createUser = function (username, email, password) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        user = new this.userModel({ email: email, username: username, password: hashedPassword });
                        return [2 /*return*/, user.save()];
                }
            });
        });
    };
    UsersService.prototype.validatePassword = function (password, hashedPassword) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
